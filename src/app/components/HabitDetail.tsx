...
export function HabitDetail() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      setHabito(await resHabito.json());
      setCompletadoHoy(await resHoy.json());
      setRegistrosSemana(await resSemana.json());
    } catch (e) {
          ...
          <div className="flex-1 space-y-6">
                ...
                {diasSemana.map((d, index) => (
                  <div key={index} className="flex flex-col items-center gap-2">
                    ...
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-semibold ${
                      ...
                      : d.esFuturo ? "bg-gray-50 dark:bg-gray-800 text-gray-300"
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-md space-y-3">
              ...
              <Textarea
                ...
                className="min-h-24 rounded-xl resize-none border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
              />
            </div>
          </div>
