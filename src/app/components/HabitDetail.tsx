...
export function HabitDetail() {
  ...
  if (cargando) return <div className="flex items-center justify-center min-h-screen"><p className="text-gray-500">Cargando...</p></div>;
  if (!habito) return <div className="flex items-center justify-center min-h-screen"><p className="text-gray-500">Hábito no encontrado</p></div>;
        ...
        <div className="p-6 space-y-6">
          <div className="bg-white rounded-2xl p-6 shadow-md">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-bold text-gray-900">Esta semana</h2>
            </div>
              ...
              {diasSemana.map((d, index) => (
                <div key={index} className="flex flex-col items-center gap-2">
                  ...
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-semibold ${
                    d.completado ? "bg-gradient-to-br from-green-400 to-emerald-500 text-white shadow-md"
                    : d.esFuturo ? "bg-gray-50 text-gray-300"
          ...
          <Button
            ...
            className={`w-full h-16 text-lg font-bold rounded-2xl shadow-lg ${
              completadoHoy ? "bg-green-500 hover:bg-green-500 cursor-not-allowed"
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md space-y-3">
            <h3 className="font-bold text-gray-900">Notas (opcional)</h3>
            <Textarea
              value={note}
              onChange={(e) => setNote(e.target.value)}
              placeholder="¿Cómo te sentiste hoy?"
              className="min-h-24 rounded-xl resize-none border-gray-200"
              disabled={completadoHoy}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white rounded-2xl p-6 shadow-md text-center">
              ...
              <p className="text-gray-500 text-sm mb-1">Racha actual</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md text-center">
              ...
              <p className="text-gray-500 text-sm mb-1">Mejor racha</p>
