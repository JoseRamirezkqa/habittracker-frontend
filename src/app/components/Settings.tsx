    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-orange-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 pb-24">
      <div className="max-w-[375px] mx-auto">
        ...
        <div className="p-6 space-y-4">
          {/* Perfil */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-md dark:shadow-gray-900 space-y-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-md dark:shadow-gray-900 space-y-4">
            ...
            <div className="space-y-2">
              {[{ code: "es", name: "Español" }, { code: "en", name: "English" }, { code: "pt", name: "Português" }].map((lang) => (
                <button
                  key={lang.code}
          ...
          {/* Notificaciones */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-md dark:shadow-gray-900">
